...
class LoginPage(Frame):
	def __init__(self,parent,*args,**kwargs):
		...
		#change title
		self.master.title('Login System - (Sagar More)')
		#icons used
		...
		#attribution
		Label(self,text='Designed and developed by Moresagar41',bg='#2bc87c',font=('arial',13)).place(x=3,y=660)
...
class RegisterPage(Frame):
	def __init__(self,parent,*args,**kwargs):
		Frame.__init__(self,parent,*args,**kwargs)
		#change title
		self.master.title('Register - (Saggy More)')
		#icons used
		self.bg=PhotoImage(file='g898.png')
		self.intr=PhotoImage(file='internet.png')
		self.wa=PhotoImage(file='whatsapp.png')
